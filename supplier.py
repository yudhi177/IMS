...
class supplierClass:
    def __init__(self, root):
        ...
        txt_search = Entry(self.root, textvariable=self.var_searchtxt, font=("goudy old style", 15), bg="lightyellow").place(x=800, y=80,width=170)
    ...
    def add(self):
        ...
        try:
            if self.var_name.get() == "":
                messagebox.showerror("Error", "Invoice name must be required", parent=self.root)
            else:
                cur.execute("Select * from suppiler where invoice=?",(self.var_sup_invoice.get(),))
                row=cur.fetchone()
                if row!= None:
...
#============================================================================================================================================
    def update(self):
        ...
        try:
            if self.var_name.get() == "":
                messagebox.showerror("Error", "Invoice no. must is required", parent=self.root)
            else:
